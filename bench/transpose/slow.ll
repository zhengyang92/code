...
for.body3:                                        ; preds = %for.body3, %for.cond1.preheader.new
  ...
  %arrayidx5 = getelementptr inbounds [512 x i32], [512 x i32]* %rA, i64 %indvars.iv, i64 %indvars.iv41
  %2 = load i32, i32* %arrayidx5, align 4, !tbaa !2
  %arrayidx9 = getelementptr inbounds [512 x i32], [512 x i32]* %rA, i64 %indvars.iv41, i64 %indvars.iv
  ...
  %arrayidx5.1 = getelementptr inbounds [512 x i32], [512 x i32]* %rA, i64 %indvars.iv.next, i64 %indvars.iv41
  %4 = load i32, i32* %arrayidx5.1, align 4, !tbaa !2
  %arrayidx9.1 = getelementptr inbounds [512 x i32], [512 x i32]* %rA, i64 %indvars.iv41, i64 %indvars.iv.next
  ...
  %arrayidx5.2 = getelementptr inbounds [512 x i32], [512 x i32]* %rA, i64 %indvars.iv.next.1, i64 %indvars.iv41
  %6 = load i32, i32* %arrayidx5.2, align 4, !tbaa !2
  %arrayidx9.2 = getelementptr inbounds [512 x i32], [512 x i32]* %rA, i64 %indvars.iv41, i64 %indvars.iv.next.1
  ...
  %arrayidx5.3 = getelementptr inbounds [512 x i32], [512 x i32]* %rA, i64 %indvars.iv.next.2, i64 %indvars.iv41
  %8 = load i32, i32* %arrayidx5.3, align 4, !tbaa !2
  %arrayidx9.3 = getelementptr inbounds [512 x i32], [512 x i32]* %rA, i64 %indvars.iv41, i64 %indvars.iv.next.2
